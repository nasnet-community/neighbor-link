...
function renderUserList() {
    ...
    users.forEach((user, index) => {
        ...
        row.innerHTML = `
            <td>${index+1}</td>
            <td>${user.username}</td>
            <td>${user.blockInternetAccess == 1 ? 'Yes' : 'No'}</td>
            <td>
...
function editUser(username) {
    ...
    if (user) {
        ...
        document.querySelector('input[name="blockInternetAccess"]').checked = user.blockInternetAccess == 1;
...
function addUser() {
    ...
    const blockInternetAccess = document.querySelector('input[name="blockInternetAccess"]').checked;
    ...
    document.getElementById('blockInternetAccess').checked = false;
